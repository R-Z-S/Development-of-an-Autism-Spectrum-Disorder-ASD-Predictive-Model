...
with st.container():
    ...
    with col1:
        ...
        st.write("""
        Autism Spectrum Disorder (ASD) is a neurodevelopmental condition characterized by challenges in social interaction, communication, and repetitive behaviors. It varies widely in severity and presentation, often affecting individuals differently. Early diagnosis and intervention can greatly improve outcomes for individuals with ASD, helping them to thrive and reach their full potential.
        """)
    with col2:
...
with st.container():
    ...
    with col1:
        ...
        st.write("""
        1. Avoids or lacks eye contact
        2. Fails to respond to name by 9 months of age
        3. Shows limited facial expressions (e.g., happy, sad, angry) by 9 months of age
        4. Engages in repetitive behavior like lining up toys and becomes upset when the order is changed
        5. Repeats words or phrases (echolalia)
        6. Displays rigid play patterns, engaging with toys in the same way each time
        7. Exhibits delayed language, movement, or cognitive skills
        8. Delayed movement skills
        9. Demonstrates hyperactive, impulsive, or inattentive behavior
